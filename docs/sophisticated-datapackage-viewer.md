...
surface. Updating schema documentation for GLC 3.0.0 is a prerequisite, but it
...
3. Add a valid, compact GLC 3.0.0 example and automated rendering tests.
...
- [x] Provide a downloadable GLC 3.0.0 schema bundle.
